...
<head>
    ...
    <title>Accueil - Car Management</title>
...
<div class="fixed top-0 left-0 h-full w-64 sidebar z-40">
    <div class="p-6">
        ...
        <nav class="space-y-2">
            <a href="VoitureServlet?action=home" class="sidebar-item flex items-center space-x-3 p-3 bg-gray-100 dark:bg-gray-700">
...
<main class="md:ml-64 pt-20 p-6 min-h-screen">
    <div class="mb-8">
        <h2 class="text-3xl font-semibold mb-6 text-center text-gray-900 dark:text-white">Bienvenue sur Car Management</h2>

        <!-- Stats Cards -->


        <!-- Featured Cars - Moved to the top as requested -->
        <div class="card p-6 mb-8">
            <h3 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Voitures en Vedette</h3>
            <div class="featured-cars">
                <c:forEach var="car" items="${featuredCars}">
                    <div class="card car-card overflow-hidden">
                        <img src="${car.imageUrl}" alt="${car.marque} ${car.modele}" class="w-full h-40 object-cover">
                        <div class="p-4">
                            <h4 class="font-semibold text-lg text-gray-900 dark:text-white">${car.marque} ${car.modele}</h4>
                            <p class="text-gray-600 dark:text-gray-400">Kilométrage: ${car.kilometrage} km</p>
                        </div>
                    </div>
                </c:forEach>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div class="card p-6">
                <h3 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Voitures les plus louées</h3>
                <div class="chart-container">
                    <canvas id="topCarsChart"></canvas>
                </div>
            </div>
            <div class="card p-6">
                <h3 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Satisfaction client</h3>
                <div class="chart-container">
        ...
        <div class="card p-6">
            <h3 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Taux d'utilisation</h3>
            <div class="chart-container">
