...
<head>
    ...
    <title>${editParc == null ? 'Ajouter' : 'Modifier'} Parc - Car Management</title>
...
<header class="header fixed top-0 left-0 right-0 z-50 p-4 flex justify-between items-center">
    <div class="flex items-center space-x-4">
        ...
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">${editParc == null ? 'Ajouter un parc' : 'Modifier le parc'}</h1>
    </div>
    <div class="flex items-center space-x-4">
...
<div class="fixed top-0 left-0 h-full w-64 sidebar z-40">
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="ParcServlet" class="sidebar-item flex items-center space-x-3 p-3 bg-gray-100 dark:bg-gray-700">
                <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<main class="md:ml-64 pt-20 p-6 min-h-screen">
    <div class="max-w-2xl mx-auto">
        <div class="card p-6 mb-6">
            <form action="ParcServlet" method="post" class="space-y-6">
                <c:if test="${editParc != null}">
                    <input type="hidden" name="id" value="${editParc.id}">
                </c:if>

                <div class="form-group">
                    <label for="capacite" class="form-label">Capacité:</label>
                    <input type="number" id="capacite" name="capacite" value="${editParc.capacite}" required class="form-input" placeholder="Nombre de véhicules">
                    <p class="text-sm text-gray-500 mt-1">Nombre maximum de véhicules que ce parc peut accueillir</p>
                </div>

                <div class="form-group">
                    <label for="adresse" class="form-label">Adresse:</label>
                    <input type="text" id="adresse" name="adresse" value="${editParc.adresse}" required class="form-input" placeholder="Adresse complète du parc">
                    <p class="text-sm text-gray-500 mt-1">Adresse physique où se trouve le parc</p>
                </div>
                ...
                <div class="flex space-x-4">
                    <button type="submit" class="btn-primary py-2 px-6 flex items-center">
                        ...
                        ${editParc == null ? 'Ajouter' : 'Modifier'}
                    </button>
                    <a href="ParcServlet" class="btn-secondary py-2 px-6 flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
