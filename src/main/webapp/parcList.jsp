...
<head>
    ...
    <title>Liste des Parcs - Car Management</title>
...
<header class="header fixed top-0 left-0 right-0 z-50 p-4 flex justify-between items-center">
    <div class="flex items-center space-x-4">
        ...
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Gestion des Parcs</h1>
    </div>
    <div class="flex items-center space-x-4">
        <div class="relative">
...
<main class="md:ml-64 pt-20 p-6 min-h-screen">
    <div class="mb-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-3xl font-semibold text-gray-900 dark:text-white">Liste des Parcs</h2>
            <a href="ParcServlet?action=add" class="add-btn">
        ...
        <div class="card table-container">
            <table class="custom-table">
                ...
                <c:forEach var="parc" items="${parcs}">
                    <tr>
                        <td>${parc.id}</td>
                        <td>${parc.capacite} véhicules</td>
                        <td>${parc.adresse}</td>
                        <td class="flex space-x-2">
                            <a href="ParcServlet?action=edit&id=${parc.id}" class="action-btn edit-btn">
                            ...
                            <a href="ParcServlet?action=delete&id=${parc.id}" onclick="return confirm('Voulez-vous supprimer ce parc ?')" class="action-btn delete-btn">
                                    <span class="flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
